...
> **Vendored from the original.** Copied from [blader/humanizer](https://github.com/blader/humanizer)
> (MIT) at version `2.8.0` (recorded in the `version` field above). Whenever this skill runs, check
